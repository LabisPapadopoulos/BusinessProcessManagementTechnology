 ...
 * 
 */
@WebFault(name = "IOException", targetNamespace = "http://services.gstam.labisp.tded.di.uoa.gr/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: gr.uoa.di.tded.labisp.gstam.services.IOException
     */
